...
<body>
	...
	<form action="exportfile.do" method="post">
		<table width="100%">
			<tr>
				<td><font color="#0000CC">您正在做的业务是：人力资源--标准数据报表--Excel标准数据报表</font>
				</td>
			</tr>
			<tr>
				<td align="right"><input type="button" value="确定"
					class="BUTTON_STYLE1" onclick="downExport();"> <input
		...
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<tr class="TR_STYLE1">
				<td class="TD_STYLE1" colspan="4">请选择要导出的字段&nbsp; <input
			...
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[0].checked" value="on">I级机构名称</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[1].checked" value="on">II级机构名称</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[2].checked" value="on">III级机构名称</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[3].checked" value="on">档案编号</td>
			</tr>
			...
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[4].checked" value="on">姓名</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[5].checked" value="on">住址</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[6].checked" value="on">邮编</td>


				<input type="hidden" name="list[7].columnCN" value="职称">
				<input type="hidden" name="list[7].columnEN"
					value="humanProDesignation">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[7].checked" value="on">职称</td>
			</tr>

			<input type="hidden" name="list[8].columnCN" value="职位分类名称">
			<input type="hidden" name="list[8].columnEN"
				value="humanMajorKindName">
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[8].checked" value="on">职位分类名称</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[9].checked" value="on">职位名称</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[10].checked" value="on">开户银行</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[11].checked" value="on">银行账户</td>
			</tr>
			...
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[12].checked" value="on">电话</td>


				<input type="hidden" name="list[13].columnCN" value="手机">
				<input type="hidden" name="list[13].columnEN"
					value="humanMobilephone">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[13].checked" value="on">手机</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[14].checked" value="on">email</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[15].checked" value="on">爱好</td>
			</tr>
			...
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[16].checked" value="on">特长</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[17].checked" value="on">性别</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[18].checked" value="on">宗教信仰</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[19].checked" value="on">政治面貌</td>
			</tr>

			<input type="hidden" name="list[20].columnCN" value="国籍">
			<input type="hidden" name="list[20].columnEN"
				value="humanNationality">
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[20].checked" value="on">国籍</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[21].checked" value="on">民族</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[22].checked" value="on">生日</td>


				<input type="hidden" name="list[23].columnCN" value="出生地">
				<input type="hidden" name="list[23].columnEN"
					value="humanBirthplace">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[23].checked" value="on">出生地</td>
			</tr>
			...
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[24].checked" value="on">年龄</td>


				<input type="hidden" name="list[25].columnCN" value="学历">
				<input type="hidden" name="list[25].columnEN"
					value="humanEducatedDegree">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[25].checked" value="on">学历</td>


				<input type="hidden" name="list[26].columnCN" value="教育年限">
				<input type="hidden" name="list[26].columnEN"
					value="humanEducatedYears">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[26].checked" value="on">教育年限</td>


				<input type="hidden" name="list[27].columnCN" value="专业">
				<input type="hidden" name="list[27].columnEN"
					value="humanEducatedMajor">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[27].checked" value="on">专业</td>
			</tr>

			<input type="hidden" name="list[28].columnCN" value="社会保障号码">
			<input type="hidden" name="list[28].columnEN"
				value="humanSocietySecurityId">
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[28].checked" value="on">社会保障号码</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[29].checked" value="on">身份证号</td>


				<input type="hidden" name="list[30].columnCN" value="薪酬标准编号">
				<input type="hidden" name="list[30].columnEN"
					value="salaryStandardId">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[30].checked" value="on">薪酬标准编号</td>


				<input type="hidden" name="list[31].columnCN" value="薪酬标准">
				<input type="hidden" name="list[31].columnEN"
					value="salaryStandardName">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[31].checked" value="on">薪酬标准</td>
			</tr>
			...
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[32].checked" value="on">基本薪酬总额</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[33].checked" value="on">实发薪酬总额</td>


				<input type="hidden" name="list[34].columnCN" value="调动次数">
				<input type="hidden" name="list[34].columnEN"
					value="majorChangeAmount">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[34].checked" value="on">调动次数</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[35].checked" value="on">激励次数</td>
			</tr>
			...
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[36].checked" value="on">培训次数</td>


				<input type="hidden" name="list[37].columnCN" value="个人履历">
				<input type="hidden" name="list[37].columnEN"
					value="humanHistroyRecords">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[37].checked" value="on">个人履历</td>


				<input type="hidden" name="list[38].columnCN" value="家庭关系信息">
				<input type="hidden" name="list[38].columnEN"
					value="humanFamilyMembership">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[38].checked" value="on">家庭关系信息</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[39].checked" value="on">备注</td>
			</tr>
			...
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[40].checked" value="on">档案变更累计</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[41].checked" value="on">登记人</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[42].checked" value="on">建档时间</td>
		</table>
		<br>
		<table class="TABLE_STYLE1" width="100%">
			...
			<tr class="TR_STYLE1">
				<td class="TD_STYLE1" width="20%">请输入建档时间</td>
