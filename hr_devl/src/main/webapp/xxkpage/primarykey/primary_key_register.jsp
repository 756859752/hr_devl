		...
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<tr>
				...
				<input type="hidden" name="list[1].primaryKey"
					value="secondKindName">
				<input type="hidden" name="list[1].keyName" value="II机机构名称">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[1].checked" value="on" checked="checked">II机机构名称
				</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[2].checked" value="on" checked="checked">III机机构名称
				</td>
			...
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[4].checked" value="on" checked="checked">姓名</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[5].checked" value="on" checked="checked">住址</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[6].checked" value="on" checked="checked">邮编</td>


				<input type="hidden" name="list[7].prkId" value="8">
				<input type="hidden" name="list[7].primaryKey"
					value="humanProDesignation">
				<input type="hidden" name="list[7].keyName" value="职称">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[7].checked" value="on" checked="checked">职称</td>
			</tr>

			<input type="hidden" name="list[8].prkId" value="9">
			<input type="hidden" name="list[8].primaryKey"
				value="humanMajorKindName">
			<input type="hidden" name="list[8].keyName" value="职位分类名称">
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[8].checked" value="on" checked="checked">职位分类名称
				</td>


				<input type="hidden" name="list[9].prkId" value="10">
				<input type="hidden" name="list[9].primaryKey"
					value="hunmaMajorName">
				<input type="hidden" name="list[9].keyName" value="职位名称">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[9].checked" value="on" checked="checked">职位名称</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[10].checked" value="on" checked="checked">开户银行</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[11].checked" value="on" checked="checked">银行帐号</td>
			</tr>

			<input type="hidden" name="list[12].prkId" value="13">
			<input type="hidden" name="list[12].primaryKey"
				value="humanTelephone">
			<input type="hidden" name="list[12].keyName" value="电话">
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[12].checked" value="on" checked="checked">电话</td>


				<input type="hidden" name="list[13].prkId" value="14">
				<input type="hidden" name="list[13].primaryKey"
					value="humanMobilephone">
				<input type="hidden" name="list[13].keyName" value="手机号码">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[13].checked" value="on" checked="checked">手机号码</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[14].checked" value="on" checked="checked">E-mail
				</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[15].checked" value="on" checked="checked">爱好</td>
			</tr>

			<input type="hidden" name="list[16].prkId" value="17">
			<input type="hidden" name="list[16].primaryKey"
				value="humanSpeciality">
			<input type="hidden" name="list[16].keyName" value="特长">
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[16].checked" value="on" checked="checked">特长</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[17].checked" value="on" checked="checked">性别</td>


				<input type="hidden" name="list[18].prkId" value="19">
				<input type="hidden" name="list[18].primaryKey"
					value="humanReligion">
				<input type="hidden" name="list[18].keyName" value="宗教信仰">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[18].checked" value="on" checked="checked">宗教信仰</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[19].checked" value="on" checked="checked">政治面貌</td>
			</tr>

			<input type="hidden" name="list[20].prkId" value="21">
			<input type="hidden" name="list[20].primaryKey"
				value="humanNationality">
			<input type="hidden" name="list[20].keyName" value="国籍">
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[20].checked" value="on" checked="checked">国籍</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[21].checked" value="on" checked="checked">民族</td>


				<input type="hidden" name="list[22].prkId" value="23">
				<input type="hidden" name="list[22].primaryKey"
					value="humanBirthday">
				<input type="hidden" name="list[22].keyName" value="生日">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[22].checked" value="on" checked="checked">生日</td>


				<input type="hidden" name="list[23].prkId" value="24">
				<input type="hidden" name="list[23].primaryKey"
					value="humanBirthplace">
				<input type="hidden" name="list[23].keyName" value="出生地">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[23].checked" value="on" checked="checked">出生地</td>
			</tr>
			...
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[24].checked" value="on" checked="checked">年龄</td>


				<input type="hidden" name="list[25].prkId" value="26">
				<input type="hidden" name="list[25].primaryKey"
					value="humanEducatedDegree">
				<input type="hidden" name="list[25].keyName" value="学历">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[25].checked" value="on" checked="checked">学历</td>


				<input type="hidden" name="list[26].prkId" value="27">
				<input type="hidden" name="list[26].primaryKey"
					value="humanEducatedYears">
				<input type="hidden" name="list[26].keyName" value="教育年限">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[26].checked" value="on" checked="checked">教育年限</td>


				<input type="hidden" name="list[27].prkId" value="28">
				<input type="hidden" name="list[27].primaryKey"
					value="humanEducatedMajor">
				<input type="hidden" name="list[27].keyName" value="专业">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[27].checked" value="on" checked="checked">专业</td>
			</tr>

			<input type="hidden" name="list[28].prkId" value="29">
			<input type="hidden" name="list[28].primaryKey"
				value="humanSocietySecurityId">
			<input type="hidden" name="list[28].keyName" value="社会保障号码">
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[28].checked" value="on" checked="checked">社会保障号码
				</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[29].checked" value="on" checked="checked">身份证号码
				</td>


				<input type="hidden" name="list[30].prkId" value="31">
				<input type="hidden" name="list[30].primaryKey"
					value="salaryStandardId">
				<input type="hidden" name="list[30].keyName" value="薪酬标准编号">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[30].checked" value="on" checked="checked">薪酬标准编号
				</td>


				<input type="hidden" name="list[31].prkId" value="32">
				<input type="hidden" name="list[31].primaryKey"
					value="salaryStandardName">
				<input type="hidden" name="list[31].keyName" value="薪酬标准">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[31].checked" value="on" checked="checked">薪酬标准</td>
			</tr>

			<input type="hidden" name="list[32].prkId" value="33">
			<input type="hidden" name="list[32].primaryKey"
				value="majorChangeAmount">
			<input type="hidden" name="list[32].keyName" value="调动次数">
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[32].checked" value="on" checked="checked">调动次数</td>
				...
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[33].checked" value="on" checked="checked">激励次数</td>


				<input type="hidden" name="list[34].prkId" value="35">
				<input type="hidden" name="list[34].primaryKey"
					value="trainingAmount">
				<input type="hidden" name="list[34].keyName" value="培训次数">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[34].checked" value="on" checked="checked">培训次数</td>


				<input type="hidden" name="list[35].prkId" value="36">
				<input type="hidden" name="list[35].primaryKey"
					value="fileChangAmount">
				<input type="hidden" name="list[35].keyName" value="档案变更次数">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[35].checked" value="on" checked="checked">档案变更次数
				</td>
			</tr>
			...
			<tr>
				<td class="TD_STYLE2"><input type="checkbox"
					name="list[36].checked" value="on" checked="checked">备注</td>


				<input type="hidden" name="list[37].prkId" value="38">
				<input type="hidden" name="list[37].primaryKey"
					value="humanHistroyRecords">
				<input type="hidden" name="list[37].keyName" value="简历">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[37].checked" value="on" checked="checked">简历</td>


				<input type="hidden" name="list[38].prkId" value="39">
				<input type="hidden" name="list[38].primaryKey"
					value="humanFamilyMembership">
				<input type="hidden" name="list[38].keyName" value="家庭关系">

				<td class="TD_STYLE2"><input type="checkbox"
					name="list[38].checked" value="on" checked="checked">家庭关系</td>
