...
<head>
 ...
 <script type="text/javascript">
  function save(){
        $("#configPublicChar").submit();   
  }
 </script>
 </head>
<body> 
                                                                                              
<form   id="configPublicChar"  name="configPublicChar" method="post" action="xxk/addconfigPublicChar.do">
<table width="100%" >
  <tr>
    <td> 
...
<table width="100%"  border="1" cellpadding=0 cellspacing=1 bordercolorlight=#848284 bordercolordark=#eeeeee class="TABLE_STYLE1">
 ...
 -->
          ...
          <td width="81%" class="TD_STYLE2"><input type="text" name="attributekind"   class="INPUT_STYLE1"></td>
          </tr>
         
          <tr>
          <td width="19%" class="TD_STYLE1">属性名称</td>
