...
<head>
 ...
 <script type="text/javascript">
  function save(){
        $("#professiondesign").submit();   
  }
 </script>
 </head>
<body>
   
<form   id="professiondesign"  name="configfilefirstkindForm" method="post" action="xxk/addProession.do">
<table width="100%" >
  <tr>
    <td> 
...
<table width="100%"  border="1" cellpadding=0 cellspacing=1 bordercolorlight=#848284 bordercolordark=#eeeeee class="TABLE_STYLE1">
          ...
          <input type="hidden" name="attributekind" value="职称" />    
          <tr>
          <td width="19%" class="TD_STYLE1">职称名称</td>
