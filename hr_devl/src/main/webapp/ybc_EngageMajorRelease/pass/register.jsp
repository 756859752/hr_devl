...
<head>
	...
	<body onload="check(),ly()">
		<form action="passRegistSubmit.do" name="fm" method="post"  enctype="multipart/form-data">
		...
		<input type="hidden" name="resId" value="${vi.resumeid.resId }"/>
			<table width="100%">
				...
				<tr>
					<td align="right">
						<input type="radio"  name="check" value="释放简历" onclick="sf()">释放简历
						<input type="radio"  name="check" value="申请录用" checked="checked" onclick="ly()">申请录用
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				class="TABLE_STYLE1">
					...
					<td width="14%" class="TD_STYLE2"> 
					   ...
					   <input type="text" name="humanMajorKindId"
