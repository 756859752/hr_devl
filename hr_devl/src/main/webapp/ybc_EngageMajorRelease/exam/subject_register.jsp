  ...
  <body>
   ...
   <table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td class="TD_STYLE2">  
					<input type="hidden" name="firstKindId">
					<select name="firstKindName" class="SELECT_STYLE1" id="firstKindName">
					<option>--请选择--</option>
					<option>${cq.firstKindName }</option>
					</select>		
					</td>
					<td class="TD_STYLE1">
						试题二级级分类
					...
					<select name="secondKindName" class="SELECT_STYLE1" id="secondKindName">
					<option>--请选择--</option>
					<option>${cq.secondKindName }</option>
					<td class="TD_STYLE1">
						姓名
					</td>
					<td class="TD_STYLE2">
