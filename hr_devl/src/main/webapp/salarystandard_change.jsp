	...
	<form action="salarystandard.do" method="post">
		...
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<input type="hidden" name="list[0].sdtId" value="1"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>1 <input type="hidden" name="list[0].itemId" value="1"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">出差补助 <input type="hidden"
					name="list[0].itemName" value="出差补助" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[0].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>

			<input type="hidden" name="list[1].sdtId" value="2"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>2 <input type="hidden" name="list[1].itemId" value="2"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">交通补贴 <input type="hidden"
					name="list[1].itemName" value="交通补贴" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[1].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[2].sdtId" value="3"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>3 <input type="hidden" name="list[2].itemId" value="3"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">住房补贴 <input type="hidden"
					name="list[2].itemName" value="住房补贴" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[2].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[3].sdtId" value="4"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>4 <input type="hidden" name="list[3].itemId" value="4"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">基本工资 <input type="hidden"
					name="list[3].itemName" value="基本工资" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[3].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[4].sdtId" value="5"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>5 <input type="hidden" name="list[4].itemId" value="5"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">年终奖 <input type="hidden"
					name="list[4].itemName" value="年终奖" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[4].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[5].sdtId" value="6"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>6 <input type="hidden" name="list[5].itemId" value="6"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">误餐补助 <input type="hidden"
					name="list[5].itemName" value="误餐补助" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[5].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[6].sdtId" value="7"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>1 <input type="hidden" name="list[6].itemId" value="1"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">出差补助 <input type="hidden"
					name="list[6].itemName" value="出差补助" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[6].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[7].sdtId" value="8"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>2 <input type="hidden" name="list[7].itemId" value="2"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">交通补贴 <input type="hidden"
					name="list[7].itemName" value="交通补贴" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[7].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[8].sdtId" value="9"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>3 <input type="hidden" name="list[8].itemId" value="3"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">住房补贴 <input type="hidden"
					name="list[8].itemName" value="住房补贴" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[8].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[9].sdtId" value="10"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>4 <input type="hidden" name="list[9].itemId" value="4"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">基本工资 <input type="hidden"
					name="list[9].itemName" value="基本工资" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[9].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[10].sdtId" value="11"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>5 <input type="hidden" name="list[10].itemId" value="5"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">年终奖 <input type="hidden"
					name="list[10].itemName" value="年终奖" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[10].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[11].sdtId" value="12"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>6 <input type="hidden" name="list[11].itemId" value="6"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">误餐补助 <input type="hidden"
					name="list[11].itemName" value="误餐补助" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[11].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[12].sdtId" value="13"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>1 <input type="hidden" name="list[12].itemId" value="1"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">出差补助 <input type="hidden"
					name="list[12].itemName" value="出差补助" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[12].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[13].sdtId" value="14"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>2 <input type="hidden" name="list[13].itemId" value="2"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">交通补贴 <input type="hidden"
					name="list[13].itemName" value="交通补贴" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[13].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[14].sdtId" value="15"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>3 <input type="hidden" name="list[14].itemId" value="3"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">住房补贴 <input type="hidden"
					name="list[14].itemName" value="住房补贴" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[14].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[15].sdtId" value="16"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>4 <input type="hidden" name="list[15].itemId" value="4"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">基本工资 <input type="hidden"
					name="list[15].itemName" value="基本工资" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[15].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[16].sdtId" value="17"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>5 <input type="hidden" name="list[16].itemId" value="5"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">年终奖 <input type="hidden"
					name="list[16].itemName" value="年终奖" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[16].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
			...
			<input type="hidden" name="list[17].sdtId" value="18"
				class="INPUT_STYLE2">
			<tr class="TD_STYLE2">
				<td>6 <input type="hidden" name="list[17].itemId" value="6"
					class="INPUT_STYLE2">
				</td>
				<td colspan="3">误餐补助 <input type="hidden"
					name="list[17].itemName" value="误餐补助" class="INPUT_STYLE2">
				</td>
				<td colspan="4"><input type="text" name="list[17].salary"
					value="0.0" class="INPUT_STYLE2"></td>
			</tr>
