...
<body>
	<form action="dcf/salarystandard/updateone.do" method="post" class="salarystandardForm">
		<table width="100%">
			<tr>
		...
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<tr>
			    <input name="Ss.ssdId" type="hidden" value="${salinfo.ss.ssdId}"/>
				<td width="12%" class="TD_STYLE1">薪酬编号</td>
				<td width="15%" class="TD_STYLE2" >${salinfo.ss.standardId}</td>
				      <input name="Ss.standardId" type="hidden" value="${salinfo.ss.standardId}"/>
			...
			<tr>
				...
				<td class="TD_STYLE2"><input type="text" id="timenow"
					name="Ss.changeTime" value="${salinfo.ss.changeTime}"
					readonly="readonly" class="INPUT_STYLE2"></td>
					<input type="hidden" name="Ss.checkTime" value="${salinfo.ss.checkTime}">
					<input type="hidden" name="Ss.registTime" value="${salinfo.ss.registTime}">
				<td class="TD_STYLE1">&nbsp;</td>
				<td class="TD_STYLE2">&nbsp;</td>
			</tr>
			
			<tr>
				   <input name="Ss.checkComment" type="hidden" value="${salinfo.ss.checkComment}"/>
				<td class="TD_STYLE1">备注</td>
				<td colspan="7" class="TD_STYLE2"><textarea name="Ss.remark"
						rows="4" class="TEXTAREA_STYLE1" >${salinfo.ss.remark}</textarea></td>
			</tr>
			<tr>
		      ...
		      <c:forEach items="${salinfo.list}" var="s" varStatus="i">
            	<tr class="TD_STYLE2">
